    ...
    namespace Graphics {
        ...
        namespace Vulkan {
            ...
            bool VKSwapchain::VKPrepareResources()
            {
                ...
                Resource::PipelineHandle pHandle = Resource::Pipeline::GetHandleFromFileName("SwapchainPipeline.json");
                m_pipeline = VKPipeline::GetHandle("SwapchainPipeline.json", pHandle);
