        ...
        namespace Vulkan {
            ...
            bool VKRenderer::VInitialize(const RendererParams & params)
            {
                ...
                */
                ...
                m_renderTarget = VKRenderTarget::GetHandle("TestRenderPass.json", "TestRenderTarget.json").StaticCastHandle<IRenderTarget>();
                ...
                Resource::PipelineHandle pHandle = Resource::Pipeline::GetHandleFromFileName("TestPipeline.json");
                IPipelineHandle pipeline = VKPipeline::GetHandle("TestPipeline.json", pHandle).StaticCastHandle<IPipeline>();
