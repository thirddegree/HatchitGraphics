...
namespace Hatchit {
    ...
    namespace Graphics {
        ...
        namespace Vulkan {
            ...
            VKMaterial::VKMaterial(VKRenderPass* renderPass) { m_renderPass = renderPass; }
            ...
            */
            void VKMaterial::VSetRasterState(const RasterizerState& rasterState)
            {
            ...
            */
            void VKMaterial::VSetMultisampleState(const MultisampleState& multiState)
            {
            ...
            */
            void VKMaterial::VLoadShader(ShaderSlot shaderSlot, IShader* shader)
            {
            ...
            bool VKMaterial::PrepareLayouts(VkDevice device)
            {
                VkResult err;
            ...
            bool VKMaterial::PrepareDescriptorSet(VkDevice device)
            {
                
                return true;
            }

            bool VKMaterial::PreparePipeline(VkDevice device) 
            {
                VkResult err;
